                ...
                <div className="mt-32 md:mt-0 relative bg-white w-11/12 md:w-3/6 shadow-lg flex flex-col items-center space-y-4 px-4 py-4 md:px-8">
                    <div className="flex items-center justify-between w-full pt-4">
                        ...
                        <span onClick={() => setIsModalVisible(false)}
                            className="cursor-pointer text-gray-100 py-2 px-2 rounded-full bg-pink-500"
                        >
                            <svg
                                className="w-6 h-6"
                                fill="none"
                    ...
                    <form className="w-full" onSubmit={handleSubmit}>
                        <div className="flex space-x-1 py-4">
                            <div className="w-full flex flex-col space-y-1 space-x-1">
                                ...
                                <input className="px-4 py-2 border-2 focus:border-pink-500" name="description" type="text" onChange={handleChangeInput} value={item.description} />
                            </div>
                        </div>
